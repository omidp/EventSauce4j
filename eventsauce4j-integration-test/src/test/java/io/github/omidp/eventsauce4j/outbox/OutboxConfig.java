...
public class OutboxConfig {
	...
	@Bean EventPublicationRepository eventPublicationRepository(EntityManager entityManager){
		return new JpaEventPublicationRepository(eventSerializer(), entityManager);
	}

	@Bean EventSerializer eventSerializer(){
